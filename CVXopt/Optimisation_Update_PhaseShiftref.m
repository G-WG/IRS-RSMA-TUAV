...
%         Optimisation_Update_PhaseShiftred(s, h_T_U_PL, h_R_U_PL, G, K, ...
...
while loop
    ...
    [opt_val, s, eta_p, beta_p] = CVX_opt_phase_shift_ref(s_IC, ...
       eta_p_IC, beta_p_IC, C, K, N_R, h_T_U_PL, h_R_U_PL, G, p_c_IC, p_k_IC, ...
    ...
    optStructure(jj_phaseshift+1).Rov = u_k'*(rate_kp+common_rates);

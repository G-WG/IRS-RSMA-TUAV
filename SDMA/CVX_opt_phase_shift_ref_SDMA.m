function [opt_val, s, eta_p, beta_p, status] = CVX_opt_phase_shift_ref_SDMA(s_IC, ...
    eta_p_IC, beta_p_IC, C, K, N_R, h_T_U_PL, h_R_U_PL, G, p_k, ...
    varianceNoise, Lambda_p)


% [opt_val, s, eta_p, beta_p, beta_c] = CVX_opt_phase_shift_ref_SDMA(s_IC, ...
%    eta_IC, beta_IC, C, K, h_T_U_PL, h_R_U_PL, G, p_k, varianceNoise)
%
% This functions performs a phase shift optimsation using CVX when SDMA
% scheme is used.
% 
% Input parameters:
